from strands import Agent #importing the Agent class from strands package
from strands_tools import http_request, file_read # hhtp request is used to make http requeests to other apis
